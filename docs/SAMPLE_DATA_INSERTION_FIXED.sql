-- ============================================================================
-- SAMPLE DATA INSERTION - Credit Risk Database (FIXED VERSION)
-- ============================================================================
...
VALUES
  ...
  (1, 1, CAST('2023-12-01' AS DATETIME), 13333333.33, 3541666.67, 16875000.00, 486666666.67, SYSUTCDATETIME()),
  (1, 2, CAST('2024-01-01' AS DATETIME), 13333333.33, 3470000.00, 16803333.33, 473333333.34, SYSUTCDATETIME()),
  (1, 3, CAST('2024-02-01' AS DATETIME), 13333333.33, 3398333.33, 16731666.66, 460000000.01, SYSUTCDATETIME()),
  (1, 4, CAST('2024-03-01' AS DATETIME), 13333333.33, 3326666.67, 16660000.00, 446666666.68, SYSUTCDATETIME()),
  (1, 5, CAST('2024-04-01' AS DATETIME), 13333333.33, 3255000.00, 16588333.33, 433333333.35, SYSUTCDATETIME()),
  
  -- Facility 3 (Customer 1 - Car Loan): 200M, 24 months, 9.5%
  (3, 1, CAST('2024-02-01' AS DATETIME), 8333333.33, 1583333.33, 9916666.66, 191666666.67, SYSUTCDATETIME()),
  (3, 2, CAST('2024-03-01' AS DATETIME), 8333333.33, 1519166.67, 9852500.00, 183333333.34, SYSUTCDATETIME()),
  (3, 3, CAST('2024-04-01' AS DATETIME), 8333333.33, 1455000.00, 9788333.33, 175000000.01, SYSUTCDATETIME()),
  
  -- Facility 4 (Customer 2 - Home Loan): 300M, 36 months, 10%
  (4, 1, CAST('2023-11-01' AS DATETIME), 8333333.33, 2500000.00, 10833333.33, 291666666.67, SYSUTCDATETIME()),
  (4, 2, CAST('2023-12-01' AS DATETIME), 8333333.33, 2430555.56, 10763888.89, 283333333.34, SYSUTCDATETIME()),
  (4, 3, CAST('2024-01-01' AS DATETIME), 8333333.33, 2361111.11, 10694444.44, 275000000.01, SYSUTCDATETIME()),
  (4, 4, CAST('2024-02-01' AS DATETIME), 8333333.33, 2291666.67, 10625000.00, 266666666.68, SYSUTCDATETIME()),
  (4, 5, CAST('2024-03-01' AS DATETIME), 8333333.33, 2222222.22, 10555555.55, 258333333.35, SYSUTCDATETIME()),
  (4, 6, CAST('2024-04-01' AS DATETIME), 8333333.33, 2152777.78, 10486111.11, 250000000.02, SYSUTCDATETIME()),
  
  -- Facility 5 (Customer 2 - Consumption): 75M, 12 months, 15%
  (5, 1, CAST('2024-02-01' AS DATETIME), 6250000.00, 937500.00, 7187500.00, 68750000.00, SYSUTCDATETIME()),
  (5, 2, CAST('2024-03-01' AS DATETIME), 6250000.00, 859375.00, 7109375.00, 62500000.00, SYSUTCDATETIME()),
  (5, 3, CAST('2024-04-01' AS DATETIME), 6250000.00, 781250.00, 7031250.00, 56250000.00, SYSUTCDATETIME()),
  
  -- Facility 6 (Customer 3 - Business): 100M, 24 months, 11.5%
  (6, 1, CAST('2023-10-01' AS DATETIME), 4166666.67, 958333.33, 5125000.00, 95833333.33, SYSUTCDATETIME()),
  (6, 2, CAST('2023-11-01' AS DATETIME), 4166666.67, 916458.33, 5083125.00, 91666666.66, SYSUTCDATETIME()),
  (6, 3, CAST('2023-12-01' AS DATETIME), 4166666.67, 874583.33, 5041250.00, 87500000.00, SYSUTCDATETIME());

PRINT 'Repayment schedules inserted: ' + CAST(@@ROWCOUNT AS VARCHAR(10));
GO

-- ============================================================================
-- STEP 7: INSERT LOAN PAYMENTS
-- ============================================================================
...
VALUES
  ...
  (1, 1, CAST('2023-12-01' AS DATETIME), 16875000.00, 13333333.33, 3541666.67, 'transfer', 'completed', SYSUTCDATETIME()),
  (1, 2, CAST('2024-01-01' AS DATETIME), 16803333.33, 13333333.33, 3470000.00, 'transfer', 'completed', SYSUTCDATETIME()),
  (1, 3, CAST('2024-02-01' AS DATETIME), 16731666.66, 13333333.33, 3398333.33, 'transfer', 'completed', SYSUTCDATETIME()),
  (1, 4, CAST('2024-03-01' AS DATETIME), 16660000.00, 13333333.33, 3326666.67, 'transfer', 'completed', SYSUTCDATETIME()),
  (1, 5, CAST('2024-04-01' AS DATETIME), 16588333.33, 13333333.33, 3255000.00, 'transfer', 'completed', SYSUTCDATETIME()),
  
  -- Facility 3 (Customer 1 - ON-TIME): All payments on time
  (3, 6, CAST('2024-02-01' AS DATETIME), 9916666.66, 8333333.33, 1583333.33, 'transfer', 'completed', SYSUTCDATETIME()),
  (3, 7, CAST('2024-03-01' AS DATETIME), 9852500.00, 8333333.33, 1519166.67, 'transfer', 'completed', SYSUTCDATETIME()),
  (3, 8, CAST('2024-04-01' AS DATETIME), 9788333.33, 8333333.33, 1455000.00, 'transfer', 'completed', SYSUTCDATETIME()),
  
  -- Facility 4 (Customer 2 - 1-30 DAYS LATE): First 3 on-time, then late
  (4, 9, CAST('2023-11-01' AS DATETIME), 10833333.33, 8333333.33, 2500000.00, 'transfer', 'completed', SYSUTCDATETIME()),
  (4, 10, CAST('2023-12-01' AS DATETIME), 10763888.89, 8333333.33, 2430555.56, 'transfer', 'completed', SYSUTCDATETIME()),
  (4, 11, CAST('2024-01-01' AS DATETIME), 10694444.44, 8333333.33, 2361111.11, 'transfer', 'completed', SYSUTCDATETIME()),
  (4, 12, CAST('2024-03-05' AS DATETIME), 10625000.00, 8333333.33, 2291666.67, 'transfer', 'completed', DATEADD(DAY, 33, SYSUTCDATETIME())),
  (4, 13, CAST('2024-04-01' AS DATETIME), 10555555.55, 8333333.33, 2222222.22, 'transfer', 'completed', SYSUTCDATETIME()),
  
  -- Facility 5 (Customer 2 - 30-90 DAYS LATE): Missing payments
  (5, 14, CAST('2024-02-01' AS DATETIME), 7187500.00, 6250000.00, 937500.00, 'transfer', 'completed', SYSUTCDATETIME()),
  (5, 15, CAST('2024-05-01' AS DATETIME), 7109375.00, 6250000.00, 859375.00, 'transfer', 'completed', DATEADD(DAY, 57, SYSUTCDATETIME())),
  
  -- Facility 6 (Customer 3 - 90+ DAYS LATE): Severely delinquent
  (6, 16, CAST('2023-10-01' AS DATETIME), 5125000.00, 4166666.67, 958333.33, 'transfer', 'completed', SYSUTCDATETIME()),
  (6, 17, CAST('2024-02-01' AS DATETIME), 10000000.00, 8333333.34, 1666666.67, 'check', 'pending', SYSUTCDATETIME());

PRINT 'Loan payments inserted: ' + CAST(@@ROWCOUNT AS VARCHAR(10));
GO

-- ============================================================================
-- STEP 8: INSERT TRANSACTION LOGS
-- ============================================================================
...
VALUES
  ...
  (1, 'payment', 16875000.00, CAST('2023-12-01' AS DATETIME), 'Monthly payment #1', SYSUTCDATETIME()),
  (1, 'payment', 16803333.33, CAST('2024-01-01' AS DATETIME), 'Monthly payment #2', SYSUTCDATETIME()),
  (1, 'payment', 16731666.66, CAST('2024-02-01' AS DATETIME), 'Monthly payment #3', SYSUTCDATETIME()),
  (1, 'interest_accrual', 3541666.67, CAST('2023-12-01' AS DATETIME), 'Interest for month 1', SYSUTCDATETIME()),
  (1, 'interest_accrual', 3470000.00, CAST('2024-01-01' AS DATETIME), 'Interest for month 2', SYSUTCDATETIME()),
  
  -- Facility 4 (Customer 2): Late payments tracked
  (4, 'payment', 10833333.33, CAST('2023-11-01' AS DATETIME), 'Monthly payment on-time', SYSUTCDATETIME()),
  (4, 'payment', 10763888.89, CAST('2023-12-01' AS DATETIME), 'Monthly payment on-time', SYSUTCDATETIME()),
  (4, 'payment', 10694444.44, CAST('2024-01-01' AS DATETIME), 'Monthly payment on-time', SYSUTCDATETIME()),
  (4, 'penalty', 50000.00, CAST('2024-03-01' AS DATETIME), 'Late payment fee (5 days)', SYSUTCDATETIME()),
  (4, 'payment', 10625000.00, CAST('2024-03-05' AS DATETIME), 'Late payment (33 days)', SYSUTCDATETIME()),
  
  -- Facility 5 (Customer 2): Severely delinquent
  (5, 'payment', 7187500.00, CAST('2024-02-01' AS DATETIME), 'Payment on-time', SYSUTCDATETIME()),
  (5, 'penalty', 100000.00, CAST('2024-04-01' AS DATETIME), 'Late payment penalty (60 days)', SYSUTCDATETIME()),
  (5, 'interest_accrual', 859375.00, CAST('2024-03-01' AS DATETIME), 'Interest accrual continued', SYSUTCDATETIME()),
  (5, 'payment', 7109375.00, CAST('2024-05-01' AS DATETIME), 'Late payment (57 days)', SYSUTCDATETIME()),
  
  -- Facility 6 (Customer 3): Default scenario
  (6, 'payment', 5125000.00, CAST('2023-10-01' AS DATETIME), 'Payment on-time', SYSUTCDATETIME()),
  (6, 'penalty', 200000.00, CAST('2023-12-01' AS DATETIME), 'Late payment penalty (60+ days)', SYSUTCDATETIME()),
  (6, 'interest_accrual', 958333.33, CAST('2023-11-01' AS DATETIME), 'Interest month 1', SYSUTCDATETIME()),
  (6, 'interest_accrual', 916458.33, CAST('2023-12-01' AS DATETIME), 'Interest month 2', SYSUTCDATETIME()),
  (6, 'penalty', 500000.00, CAST('2024-02-01' AS DATETIME), 'Default penalty (90+ days)', SYSUTCDATETIME()),
  (6, 'payment', 10000000.00, CAST('2024-02-01' AS DATETIME), 'Partial payment after default', SYSUTCDATETIME());
...
VALUES
  ...
  (1, CAST('2024-04-01' AS DATETIME), 0, 0.00, 'GROUP_1', SYSUTCDATETIME()),
  (1, CAST('2024-05-01' AS DATETIME), 0, 0.00, 'GROUP_1', SYSUTCDATETIME()),
  
  -- Facility 3 (Customer 1 - ON-TIME): No delinquency
  (3, CAST('2024-04-01' AS DATETIME), 0, 0.00, 'GROUP_1', SYSUTCDATETIME()),
  (3, CAST('2024-05-01' AS DATETIME), 0, 0.00, 'GROUP_1', SYSUTCDATETIME()),
  
  -- Facility 4 (Customer 2 - 1-30 DAYS LATE): GROUP_2
  (4, CAST('2024-03-15' AS DATETIME), 15, 10625000.00, 'GROUP_2', SYSUTCDATETIME()),
  (4, CAST('2024-04-01' AS DATETIME), 1, 10625000.00, 'GROUP_2', SYSUTCDATETIME()),
  (4, CAST('2024-05-01' AS DATETIME), 0, 0.00, 'GROUP_1', SYSUTCDATETIME()),
  
  -- Facility 5 (Customer 2 - 30-90 DAYS LATE): GROUP_3
  (5, CAST('2024-03-01' AS DATETIME), 30, 7109375.00, 'GROUP_3', SYSUTCDATETIME()),
  (5, CAST('2024-04-01' AS DATETIME), 61, 7109375.00, 'GROUP_3', SYSUTCDATETIME()),
  (5, CAST('2024-05-01' AS DATETIME), 0, 0.00, 'GROUP_1', SYSUTCDATETIME()),
  
  -- Facility 6 (Customer 3 - 90+ DAYS DEFAULT): GROUP_4
  (6, CAST('2023-12-01' AS DATETIME), 61, 10083125.00, 'GROUP_3', SYSUTCDATETIME()),
  (6, CAST('2024-01-01' AS DATETIME), 92, 10083125.00, 'GROUP_4', SYSUTCDATETIME()),
  (6, CAST('2024-02-01' AS DATETIME), 122, 10083125.00, 'GROUP_4', SYSUTCDATETIME());

PRINT 'Loan delinquency records inserted: ' + CAST(@@ROWCOUNT AS VARCHAR(10));
GO

-- ============================================================================
-- STEP 10: INSERT MONTHLY DELINQUENCY SNAPSHOTS
-- ============================================================================
...
VALUES
  ...
  (1, CAST('2024-01-01' AS DATETIME), 0, 'GROUP_1', 0.00, 0.00, 0.00, 100.0, 0, SYSUTCDATETIME()),
  (1, CAST('2024-02-01' AS DATETIME), 0, 'GROUP_1', 0.00, 0.00, 0.00, 100.0, 0, SYSUTCDATETIME()),
  (1, CAST('2024-03-01' AS DATETIME), 0, 'GROUP_1', 0.00, 0.00, 0.00, 100.0, 0, SYSUTCDATETIME()),
  (1, CAST('2024-04-01' AS DATETIME), 0, 'GROUP_1', 0.00, 0.00, 0.00, 100.0, 0, SYSUTCDATETIME()),
  
  -- Facility 3 (Customer 1 - EXCELLENT): All on-time
  (3, CAST('2024-02-01' AS DATETIME), 0, 'GROUP_1', 0.00, 0.00, 0.00, 100.0, 0, SYSUTCDATETIME()),
  (3, CAST('2024-03-01' AS DATETIME), 0, 'GROUP_1', 0.00, 0.00, 0.00, 100.0, 0, SYSUTCDATETIME()),
  (3, CAST('2024-04-01' AS DATETIME), 0, 'GROUP_1', 0.00, 0.00, 0.00, 100.0, 0, SYSUTCDATETIME()),
  
  -- Facility 4 (Customer 2 - SPECIAL MENTION): 1-30 days late
  (4, CAST('2024-02-01' AS DATETIME), 0, 'GROUP_1', 0.00, 0.00, 0.00, 100.0, 0, SYSUTCDATETIME()),
  (4, CAST('2024-03-01' AS DATETIME), 15, 'GROUP_2', 10625000.00, 0.00, 10625000.00, 75.0, 1, SYSUTCDATETIME()),
  (4, CAST('2024-04-01' AS DATETIME), 1, 'GROUP_2', 10625000.00, 0.00, 10625000.00, 75.0, 1, SYSUTCDATETIME()),
  (4, CAST('2024-05-01' AS DATETIME), 0, 'GROUP_1', 0.00, 0.00, 0.00, 80.0, 1, SYSUTCDATETIME()),
  
  -- Facility 5 (Customer 2 - SUBSTANDARD): 30-90 days late
  (5, CAST('2024-02-01' AS DATETIME), 0, 'GROUP_1', 0.00, 0.00, 0.00, 100.0, 0, SYSUTCDATETIME()),
  (5, CAST('2024-03-01' AS DATETIME), 30, 'GROUP_3', 7109375.00, 0.00, 7109375.00, 50.0, 2, SYSUTCDATETIME()),
  (5, CAST('2024-04-01' AS DATETIME), 61, 'GROUP_3', 7109375.00, 0.00, 7109375.00, 33.0, 3, SYSUTCDATETIME()),
  (5, CAST('2024-05-01' AS DATETIME), 0, 'GROUP_1', 0.00, 0.00, 0.00, 50.0, 3, SYSUTCDATETIME()),
  
  -- Facility 6 (Customer 3 - DOUBTFUL): 90+ days default
  (6, CAST('2023-10-01' AS DATETIME), 0, 'GROUP_1', 0.00, 0.00, 0.00, 100.0, 0, SYSUTCDATETIME()),
  (6, CAST('2023-11-01' AS DATETIME), 30, 'GROUP_3', 4166666.67, 0.00, 4166666.67, 50.0, 1, SYSUTCDATETIME()),
  (6, CAST('2023-12-01' AS DATETIME), 61, 'GROUP_3', 8333333.34, 0.00, 8333333.34, 25.0, 2, SYSUTCDATETIME()),
  (6, CAST('2024-01-01' AS DATETIME), 92, 'GROUP_4', 12500000.00, 0.00, 12500000.00, 0.0, 4, SYSUTCDATETIME()),
  (6, CAST('2024-02-01' AS DATETIME), 122, 'GROUP_4', 10083125.00, 0.00, 10083125.00, 0.0, 5, SYSUTCDATETIME());

PRINT 'Monthly delinquency snapshots inserted: ' + CAST(@@ROWCOUNT AS VARCHAR(10));
GO

-- ============================================================================
-- STEP 11: INSERT LOAN STATUS MIGRATIONS
-- ============================================================================
...
VALUES
  ...
  (4, 'GROUP_1', 'GROUP_2', CAST('2024-03-01' AS DATETIME), 'Payment missed by 15 days'),
  (4, 'GROUP_2', 'GROUP_1', CAST('2024-04-05' AS DATETIME), 'Made up late payment'),
  
  -- Facility 5 (Customer 2): GROUP_1 → GROUP_3 → GROUP_1
  (5, 'GROUP_1', 'GROUP_3', CAST('2024-03-01' AS DATETIME), 'Payment 30-90 days late'),
  (5, 'GROUP_3', 'GROUP_1', CAST('2024-05-01' AS DATETIME), 'Made full payment after default'),
  
  -- Facility 6 (Customer 3): GROUP_1 → GROUP_3 → GROUP_4 (stays in default)
  (6, 'GROUP_1', 'GROUP_3', CAST('2023-11-01' AS DATETIME), 'Payment 30+ days late'),
  (6, 'GROUP_3', 'GROUP_4', CAST('2024-01-01' AS DATETIME), 'Payment 90+ days late - DEFAULT');
