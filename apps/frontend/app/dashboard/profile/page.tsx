...
export default function ProfilePage() {
  ...
  type ProfileTab = 'general' | 'email' | 'security';
  ...
  return (
    <div className="flex flex-col gap-6 p-6 bg-[#f4f7fc]">
      ...
      <div className="w-full space-y-4">
        <SegmentedFilter<ProfileTab>
          aria-label={isVi ? 'Phần hồ sơ' : 'Profile sections'}
          value={profileTab}
          onValueChange={setProfileTab}
          options={[
            { value: 'general', label: t('profile.tab.general') },
            { value: 'email', label: 'Email' },
            { value: 'security', label: t('profile.tab.security') },
          ]}
        />
