...
import { RECHARTS_GRID_STROKE, RECHARTS_LEGEND_WRAPPER_STYLE, RECHARTS_TICK } from '@/lib/chart-theme';
        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={scenarioData}>
              ...
              <XAxis dataKey="change" tick={RECHARTS_TICK} />
              <YAxis domain={[0, 100]} tickFormatter={(v) => `${v}`} width={40} tick={RECHARTS_TICK} />
